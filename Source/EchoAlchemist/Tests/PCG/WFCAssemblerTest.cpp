...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FWFCAssemblerTest_BasicAssembly, "EchoAlchemist.PCG.WFCAssembler.BasicAssembly", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FWFCAssemblerTest_ConnectorCompatibility, "EchoAlchemist.PCG.WFCAssembler.ConnectorCompatibility", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FWFCAssemblerTest_Determinism, "EchoAlchemist.PCG.WFCAssembler.Determinism", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FWFCAssemblerTest_GridCoordinates, "EchoAlchemist.PCG.WFCAssembler.GridCoordinates", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FWFCAssemblerTest_DifferentSeeds, "EchoAlchemist.PCG.WFCAssembler.DifferentSeeds", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FWFCAssemblerTest_EdgeCases, "EchoAlchemist.PCG.WFCAssembler.EdgeCases", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::ProductFilter)

...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FAppearanceAssemblerTest_CalculateMonsterScale, "EchoAlchemist.PCG.AppearanceAssembler.CalculateMonsterScale", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FAppearanceAssemblerTest_GetAnchorPointLocation, "EchoAlchemist.PCG.AppearanceAssembler.GetAnchorPointLocation", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FAppearanceAssemblerTest_GetPaletteForHabitat, "EchoAlchemist.PCG.AppearanceAssembler.GetPaletteForHabitat", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FAppearanceAssemblerTest_CreatePaletteSwapMaterial, "EchoAlchemist.PCG.AppearanceAssembler.CreatePaletteSwapMaterial", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FAppearanceAssemblerTest_Integration, "EchoAlchemist.PCG.AppearanceAssembler.Integration", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::ProductFilter)
